#-----This is file is to test whether script works or not on a single system----------------------
#-----To start you need to run one script via your IDE and another via terminal using the file path------------
